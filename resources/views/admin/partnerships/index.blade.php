            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="white-space:nowrap">
                        ...
                        <form action="{{ route('admin.partnerships.destroy', $p) }}" method="POST" class="d-inline" onsubmit="return delConfirm(event, this, '{{ addslashes($p->name) }}')">@csrf @method('DELETE')<button class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></button></form>
                    </td>
                </tr>
