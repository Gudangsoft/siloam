            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="white-space:nowrap">
                        ...
                        <form action="{{ route('admin.facilities.destroy', $f) }}" method="POST" class="d-inline" onsubmit="return delConfirm(event, this, '{{ addslashes($f->name) }}')">@csrf @method('DELETE')<button class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></button></form>
                    </td>
                </tr>
